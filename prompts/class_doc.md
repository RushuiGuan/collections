Create or update XML documentation comments for Albatross.Collections and Albatross.Collections.Intervals.
...
- Do not put documentation for interface members if their names are self explaining.
